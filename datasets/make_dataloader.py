...
from .preprocessing import RandomErasing_Background
...
def make_dataloader(cfg):
    ...
    return train_loader, train_loader_normal, val_loader, len(dataset.query), num_classes, cam_num, view_num, dataset
